...
import { slide_genuine } from "../../assets/fake-data/Start-Slider";
...
function SlideTop(props) {
  const [title, slideStatus, products] = props;
          ...
          <Slider {...settings}>
            {products.map((item, index) => (
              <div style={{ width: 247 }} key={index}>
                <Link
                  to={`/${item.category}/${item.name.replace(/ /g, "-")}/${
                    item.id
                  }`}
                >
                  <Badge.Ribbon
                    ...
                    style={{
                      right: "0px",
                      display: item.util > 50 ? "block" : "none",
                    }}
                    key={index}
                  >
                    <Card
                      hoverable
                      cover={<img alt="example" src={item.image[0][0]} />}
                    ...
                    >
                      <Meta
                        ...
                        description={
                          item.util > 50 ? "Sắp bán hết" : "Vẫn còn nhiều hàng"
                        }
                      />
                      <div style={{ width: 170 }}>
                        <Progress
